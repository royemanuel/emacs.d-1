#+TITLE: Roy Emanuel's Emacs 26 Configuration JHU/APL
...
** Environment
   ...
   #+begin_src emacs-lisp
     ...
     ;; (add-to-list 'exec-path "c:/Users/Roy/anaconda3/bin")
     ;; (setenv "PATH" "c:/Users/Roy/anadonda3/bin:$PATH" '("PATH"))
     (require 'cl)
   #+end_src
** Package Management
   :PROPERTIES:
...
;;(setenv "WORKON_HOME" "c:/Users/Roy/anaconda3/envs")
(pyvenv-mode 1)
;;(setq conda-anaconda-home (expand-file-name "c:/Users/Roy/anaconda3"))
;;(setq conda-env-home-directory (expand-file-name "c:/Users/Roy/anaconda3"))
#+end_src
*** shell-script-mode
    :PROPERTIES:
